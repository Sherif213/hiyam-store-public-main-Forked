  ...
  return (
    <Fragment>
      <SEO
        ...
        description="Wishlist page of Hiyam react minimalist eCommerce template."
      />
      <LayoutOne headerTop="visible">
        ...
        <Breadcrumb 
          pages={[
            ...
            {label: t("Wishlist"), path: process.env.PUBLIC_URL + pathname }
          ]} 
        />
        <div className="cart-main-area pt-90 pb-100">
          <div className="container">
            {wishlistItems && wishlistItems.length >= 1 ? (
              <Fragment>
                <h3 className="cart-page-title">{t("Your wishlist items")}</h3>
                <div className="row">
                ...
                <div className="col-lg-12">
                  <div className="item-empty-area text-center">
                    ...
                    <div className="item-empty-area__text">
                      {t("No items found in wishlist")} <br />{" "}
