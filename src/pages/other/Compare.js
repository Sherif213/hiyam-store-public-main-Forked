  ...
  return (
    <Fragment>
      <SEO
        ...
        description="Compare page of Hiyam react minimalist eCommerce template."
      />
      <LayoutOne headerTop="visible">
        ...
        <Breadcrumb 
          pages={[
            ...
            {label: t("Compare"), path: process.env.PUBLIC_URL + pathname }
          ]} 
        />
                  ...
                  <div className="compare-page-content">
                    <div className="compare-table table-responsive">
                      <table className="table table-bordered mb-0">
                        <tbody>
                          <tr>
                            <th className="title-column">{t("Product Info")}</th>
                            ...
                            {compareItems.map((compareItem, key) => {
                              return (
                                <td className="product-desc" key={key}>
                                  <p>
                                    {t(compareItem.shortDescription)
                                      ? t(compareItem.shortDescription)
                                      : "N/A"}
                                  </p>
                                </td>
                ...
                <div className="col-lg-12">
                  <div className="item-empty-area text-center">
                    ...
                    <div className="item-empty-area__text">
                      {t("No items found in compare")} <br />{" "}
