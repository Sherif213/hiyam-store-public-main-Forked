      ...
      <LayoutOne headerTop="visible">
        ...
        <Breadcrumb
          pages={[
            ...
            { label: t("Returns"), path: process.env.PUBLIC_URL + pathname },
          ]}
        />
...
<p>TÜKETİCİ, bu prosedürü okuduğunu ve kabul ettiğini kabul ve taahhüt eder.</p>
<p>3.5- iptal Prosedürü:</p>
<p>Alıcı siparişi iptal ederse;</p> 
<p>a) ödemeyi havale ile yapmış ise iptalinden itibaren 14 gün içinde kendisine havale olarak bu ücret ödenir. </p>
    <p>b)Alıcı,ödemeyi kredi kartı ile yapmış ise ve iptal ederse, bu iptalden itibaren yine 14 gün içinde ürün bedeli bankaya iade edilir, ancak bankanın alıcının hesabına 2-3 hafta içerisinde aktarması olasıdır.</p>
<p>3.6- Teslimat Şekli ve Adresi:</p>
<p>Teslimat Adresi:</p>
