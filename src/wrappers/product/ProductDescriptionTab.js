...
const ProductDescriptionTab = ({
  ...
  const createReview = async (e) => {
    ...
    if (!newReview.rating || !newReview.message) {
            ...
            <Tab.Content className="description-review-bottom">
              <Tab.Pane eventKey="additionalInfo">
                <div className="product-anotherinfo-wrapper">
                  <ul>
                    <li>
                      <span>{t("Weight")}: {t(productWeight)}</span>
                    </li>
                    <li>
                      <span>{t("Type")}: {t(productType)}</span>
                    </li>
                    <li>
                      <span>{t("Skin Type")}: {t(skinType)}</span>
                    </li>
                    <li>
                      <span>{t("Materials")}: {t(Materials)}</span>
                    </li>
                  </ul>
                </div>
              </Tab.Pane>
                      ...
                      <div className="ratting-form mt-4">
                        <form onSubmit={createReview}>
                          <div className="star-box">
                            <h4 className="mr-15">{t("Your rating")}:</h4>
                            ...
                            <div className="col-md-12">
                              <div className="rating-form-style form-submit">
                                ...
                                <input
                                  disabled={loading}
                                  type="submit"
                                  value={loading ? "Submitting..." : t("Submit")}
                                />
                              </div>
                            </div>
                          </div>
