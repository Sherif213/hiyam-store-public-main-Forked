      ...
      <div className={clsx("product-wrap", spaceBottomClass)}>
        <div className="product-img">
          ...
          <div className="product-action">
            ...
            <div className="pro-same-action pro-quickview">
              <button onClick={() => setModalShow(true)} title={t("Quick View")}>
        ...
        <div className="product-content text-center">
          ...
          <div className="product-price">
            {discountedPrice !== null && product?.price < product?.oldPrice ? (
              <Fragment>
              ...
              <span>
                {currency.currencySymbol + finalProductPrice.toString()}{" "}
              </span>
            )}
          </div>
        </div>
          ...
          <div className="col-xl-8 col-md-7 col-sm-6">
            <div className="shop-list-content">
              ...
              {t(product?.shortDescription) ? (
                <p>{t(product?.shortDescription)}</p>
              ) : (
                ""
              )}
              ...
              <div className="shop-list-actions d-flex align-items-center">
                <div className="shop-list-btn btn-hover">
                  {product?.affiliateLink ? (
                    ...
                    <button disabled className={t("active")}>
                      {t("Out of Stock")}
                    </button>
                  )}
                </div>
